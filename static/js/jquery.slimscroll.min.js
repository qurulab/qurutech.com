  ...
  e.fn.extend({
    slimScroll(f) {
      ...
      this.each(function() {
        ...
        function n(d, g, e) {
          k = !1
          const f = b.outerHeight() - c.outerHeight()
          g &&
            ((g =
              parseInt(c.css('top')) +
              ((d * parseInt(a.wheelStep)) / 100) * c.outerHeight()),
            (g = Math.min(Math.max(g, 0), f)),
            (g = d > 0 ? Math.ceil(g) : Math.floor(g)),
            c.css({ top: g + 'px' }))
        ...
        function x() {
          ...
          c.css({ height: u + 'px' })
          const a = u == b.outerHeight() ? 'none' : 'block'
          c.css({ display: a })
        }
        function w() {
          x()
          ...
          l == ~~l
            ? ((k = a.allowPageScroll),
              C != l && b.trigger('slimscroll', ~~l == 0 ? 'top' : 'bottom'))
            : (k = !1)
          C = l
          u >= b.outerHeight()
            ? (k = !0)
        ...
        if (b.parent().hasClass(a.wrapperClass)) {
          var q = b.scrollTop()
          var c = b.siblings('.' + a.barClass)
          var m = b.siblings('.' + a.railClass)
          x()
          ...
          a.height = a.height == 'auto' ? b.parent().height() : a.height
          q = e('<div></div>')
          ...
          var h =
            a.position == 'right' ? { right: a.distance } : { left: a.distance }
          m.css(h)
          c.css(h)
          b.wrap(q)
          b.parent().append(c)
