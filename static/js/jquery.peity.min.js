...
!(function(t, i, e, n) {
  ...
  ;(h.draw = function() {
    ...
    a.register(
      ...
      function(i) {
        if (!i.delimiter) {
          const n = this.$el.text().match(/[^0-9\.]/)
          i.delimiter = n ? n[0] : ','
        }
        let a = t.map(this.values(), function(t) {
          return t > 0 ? t : 0
        })
        if (i.delimiter == '/') {
          const r = a[0]
        ...
        o || ((p = 2), (o = 1), (a = [0, 1]))
        const f = 2 * i.radius
        const c = this.prepare(i.width || f, i.height || f)
        const u = c.width() / 2
        const d = c.height() / 2
        const g = e.min(u, d)
        let v = i.innerRadius
        this.type != 'donut' || v || (v = 0.5 * g)
        const m = e.PI
        const y = this.fill()
        const w = (this.scale = function(t, i) {
          const n = (t / o) * m * 2 - m / 2
